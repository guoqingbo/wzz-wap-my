        ...
        a.fn.dropload = function(a) {
            ...
            f.prototype.init = function(f) {
                ...
                k.opts = a.extend({},
                    {
                        ...
                        domDown: {
                            ...
                            domLoad: '<div class="dropload-load"><span class="loading"></span>加载中...</div>',
                            domNoData: '<div class="dropload-noData"><i class="icon-iconfont-gantanhaom"></i>暂无更多数据</div>'
                        },
                        distance: 50,
                        threshold: "",
                        loadUpFn: "",
                ...
                "" != k.opts.loadDownFn && (k.$element.append('<div class="' + k.opts.domDown.domClass + '">' + k.opts.domDown.domRefresh + "</div>"), k.$domDown = a("." + k.opts.domDown.domClass)),
                    k.opts.scrollArea == b ? (k.$scrollArea = d, k._scrollContentHeight = e.height(), k._scrollWindowHeight = c.documentElement.scrollHeight) : (k.$scrollArea = k.opts.scrollArea, k._scrollContentHeight = k.$element[0].scrollHeight, k._scrollWindowHeight = k.$element.height()),
